		...
		<div class="row justify-content-md-center">
			<div class="col-md-6 ">
				<div class="details_form">
					<form method="POST" action="donationserver.php" enctype="multipart/form-data">
						<br>
					    ...
					    <input type="text"  name="petname"  class="form-control" id="exampleFormControlInput1" placeholder="Type">
					  </div>
					  <div class="form-group">
					    <label for="exampleFormControlInput1">Pet Type</label>
					    <input type="text"  name="pettype"  class="form-control" id="exampleFormControlInput1" placeholder="Type">
					  </div>
					  <div class="form-group">
					    <label for="exampleFormControlSelect1">Pet Gender</label>
					    <select class="form-control"  name="petgen"  id="exampleFormControlSelect1">
					      <option>Male</option>
					      <option>Female</option>					   
					    </select>
					  </div>
					  <div class="form-group">
					    <label for="exampleFormControlInput1">Pet Age In Month</label>
					    <input type="number" class="form-control" name="petage"    id="exampleFormControlInput1" placeholder="2">
					  </div>
					  <div class="form-group">
					    <label for="exampleFormControlTextarea1">Details</label>
					    <textarea class="form-control"  name="petdetails"  id="exampleFormControlTextarea1" rows="3"></textarea>
					  </div>
					  <div class="custom-file">
					    <input type="file" name="petphoto" class="custom-file-input" id="customFile" placeholder="Pet Photo">
					    <label class="custom-file-label" for="customFile">Pet Photo</label>
					  </div>
					  <br>
					  <br>
					  <button type="submit" name="submit" class="profile100-form-btn">Donate</button>
					</form>
